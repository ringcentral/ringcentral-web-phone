...
import { WebSessionDescriptionHandler, WebSessionDescriptionHandlerOptions } from 'sip.js/types/Web/session-description-handler';
...
import { SessionDescriptionHandlerModifiers, SessionDescriptionHandlerObserver } from 'sip.js/lib/Web/SessionDescriptionHandlerObserver';
import { Logger } from 'sip.js/types/logger-factory';
export declare class DefaultSessionDescriptionHandler extends EventEmitter implements WebSessionDescriptionHandler {
    /**
     * @param {SIP.Session} session
     * @param {Object} [options]
     */
    static defaultFactory(session: InviteClientContext | InviteServerContext, options: any): DefaultSessionDescriptionHandler;
    type: TypeStrings;
