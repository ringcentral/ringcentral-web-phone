...
exports.patchSession = function (session) {
    ...
    session.ua.transport.on('disconnected', function () {
    ...
    session.ua.on('registered', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!session.__shouldSendReinviteOnReconnect) return [3 /*break*/, 2];
                    session.logger.log('Sending reinvite after successful registration');
                    return [4 /*yield*/, session.reinvite()];
                case 1:
                    _a.sent();
