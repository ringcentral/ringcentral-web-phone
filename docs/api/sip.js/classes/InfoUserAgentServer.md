[SIP.js](../README.md) / [Exports](../modules.md) / InfoUserAgentServer

# Class: InfoUserAgentServer
...
- [constructor](InfoUserAgentServer.md#constructor)

### Properties

- [message](InfoUserAgentServer.md#message)
- [delegate](InfoUserAgentServer.md#delegate)

### Methods

- [dispose](InfoUserAgentServer.md#dispose)
- [accept](InfoUserAgentServer.md#accept)
- [progress](InfoUserAgentServer.md#progress)
- [redirect](InfoUserAgentServer.md#redirect)
- [reject](InfoUserAgentServer.md#reject)
- [trying](InfoUserAgentServer.md#trying)
- [receiveCancel](InfoUserAgentServer.md#receivecancel)

### Accessors

- [loggerFactory](InfoUserAgentServer.md#loggerfactory)
- [transaction](InfoUserAgentServer.md#transaction)

## Constructors

### constructor

• **new InfoUserAgentServer**(`dialog`, `message`, `delegate?`)
...
sip.js/lib/core/user-agents/info-user-agent-server.d.ts:9
...
[IncomingInfoRequest](../interfaces/IncomingInfoRequest.md).[message](../interfaces/IncomingInfoRequest.md#message)
...
[IncomingInfoRequest](../interfaces/IncomingInfoRequest.md).[delegate](../interfaces/IncomingInfoRequest.md#delegate)
...
[IncomingInfoRequest](../interfaces/IncomingInfoRequest.md).[accept](../interfaces/IncomingInfoRequest.md#accept)
...
[IncomingInfoRequest](../interfaces/IncomingInfoRequest.md).[progress](../interfaces/IncomingInfoRequest.md#progress)
...
[IncomingInfoRequest](../interfaces/IncomingInfoRequest.md).[redirect](../interfaces/IncomingInfoRequest.md#redirect)
...
[IncomingInfoRequest](../interfaces/IncomingInfoRequest.md).[reject](../interfaces/IncomingInfoRequest.md#reject)
...
[IncomingInfoRequest](../interfaces/IncomingInfoRequest.md).[trying](../interfaces/IncomingInfoRequest.md#trying)
