[SIP.js](../README.md) / [Exports](../modules.md) / TransactionStateError
...
- [captureStackTrace](TransactionStateError.md#capturestacktrace)
- [prepareStackTrace](TransactionStateError.md#preparestacktrace)

### Properties

- [stackTraceLimit](TransactionStateError.md#stacktracelimit)
- [name](TransactionStateError.md#name)
- [message](TransactionStateError.md#message)
- [stack](TransactionStateError.md#stack)

### Constructors

- [constructor](TransactionStateError.md#constructor)
...
• **new TransactionStateError**(`message?`)
...
sip.js/lib/core/exceptions/transaction-state-error.d.ts:7
