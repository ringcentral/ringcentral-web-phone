[SIP.js](../README.md) / [Exports](../modules.md) / OutgoingPrackRequest

# Interface: OutgoingPrackRequest
...
- [delegate](OutgoingPrackRequest.md#delegate)
- [message](OutgoingPrackRequest.md#message)

### Methods

- [dispose](OutgoingPrackRequest.md#dispose)
- [cancel](OutgoingPrackRequest.md#cancel)
