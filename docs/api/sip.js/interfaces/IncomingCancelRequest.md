[SIP.js](../README.md) / [Exports](../modules.md) / IncomingCancelRequest

# Interface: IncomingCancelRequest
...
- [delegate](IncomingCancelRequest.md#delegate)
- [message](IncomingCancelRequest.md#message)

### Methods

- [accept](IncomingCancelRequest.md#accept)
- [progress](IncomingCancelRequest.md#progress)
- [redirect](IncomingCancelRequest.md#redirect)
- [reject](IncomingCancelRequest.md#reject)
- [trying](IncomingCancelRequest.md#trying)
