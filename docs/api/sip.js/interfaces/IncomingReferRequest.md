[SIP.js](../README.md) / [Exports](../modules.md) / IncomingReferRequest

# Interface: IncomingReferRequest
...
- [delegate](IncomingReferRequest.md#delegate)
- [message](IncomingReferRequest.md#message)

### Methods

- [accept](IncomingReferRequest.md#accept)
- [progress](IncomingReferRequest.md#progress)
- [redirect](IncomingReferRequest.md#redirect)
- [reject](IncomingReferRequest.md#reject)
- [trying](IncomingReferRequest.md#trying)
