[SIP.js](../README.md) / [Exports](../modules.md) / IncomingNotifyRequest

# Interface: IncomingNotifyRequest
...
- [delegate](IncomingNotifyRequest.md#delegate)
- [message](IncomingNotifyRequest.md#message)

### Methods

- [accept](IncomingNotifyRequest.md#accept)
- [progress](IncomingNotifyRequest.md#progress)
- [redirect](IncomingNotifyRequest.md#redirect)
- [reject](IncomingNotifyRequest.md#reject)
- [trying](IncomingNotifyRequest.md#trying)
